...
try {
    ...
    $mail->Host = gethostbyname('smtp.gmail.com'); //smtp2.example.com';  // Specify main and backup SMTP servers
    ...
    $mail->addAddress("ratnadeepika49@gmail.com",'Deepika');
   ...
   // $mail->addReplyTo('info@example.com', 'Information');
    ...
    //$mail->Body    = '<b>'.$_SESSION['text'].'</b>';
    $mail->Body="your request is accepted";
